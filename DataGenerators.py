...
def testDataGenerator():
    ...
    pathToTrainingData = '//home/kwaygo/Documents/Abdominal_Adipose_Segmentation/Code_For_Git/tmp/Test_Evaluation_Code/Test_Training_Data/Children/'
    IdlistPath = os.path.join(pathToTrainingData, 'validation_IDs.csv')
